...
{
    public partial class FrmListMenu : System.Web.UI.Page
    {
        ...
        public void DisplayData()
        {
            ...
            try
            {
                ...
                m.NamaMenu = txtNamaMenu.Text.Trim();
                var data = m.GetListMenu(db);
        ...
        public void ButtonClicked(object sender, EventArgs e)
        {
            ...
            else if (ib == imgbtnRefresh)
            {
                ...
                Response.Redirect(String.Format("~/Form/Administrasi/FrmMenu.aspx?state={0}", ActionDef.ADD));
        }
        ...
        protected void OnGridRowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            { 
                ...
                String url = String.Format("~/Form/Administrasi/FrmMenu.aspx?state={0}&id_menu={1}",
