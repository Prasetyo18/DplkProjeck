...
{
    public partial class FundSwitching_MoneyType : System.Web.UI.UserControl
    {
        Database db;
        Connection conn;
        ...
        private void FillGvEstimation()
        {
            ...
            {
                db.Open();
                GvEst.DataSource = FundSwitchingModels.FillGvEstimationMT(db, int.Parse(txtCerNmbr.Text), txtTransactionDt.Text);
                GvEst.DataBind();
            }
            catch (Exception ex)
            {
        ...
        private void FirstSaveComposition()
        {
            try
            {
                ...
                for (int i = 0; i < GvFund.Rows.Count; i++)
                {
                    ...
                    fundSwitching.CurrentAsset = float.Parse(GvFund.Rows[i].Cells[2].Text.Replace(",", ""));
                    ...
                    fundSwitching.MoneyTypeNm = GvFund.Rows[i].Cells[1].Text.Replace(",", "");
        ...
        private void FillGvFund()
        {
            ...
            {
                db.Open();
                GvFund.DataSource = FundSwitchingModels.FillGvFundMT(db, int.Parse(txtCerNmbr.Text), txtTransactionDt.Text);
                GvFund.DataBind();
            }
            catch (Exception ex)
            {
        ...
        private void BindEmptyGvEst()
        {
            ...
            {
                db.Open();
                GvFund.DataSource = FundSwitchingModels.BindEmptyGvEstMT(db);
                GvFund.DataBind();
            }
            catch (Exception ex)
            {
        ...
        private void BindEmptyGvFund()
        {
            ...
            {
                db.Open();
                GvEst.DataSource = FundSwitchingModels.BindEmptyGvFundMT(db);
                GvEst.DataBind();
            }
            catch (Exception ex)
            {
        ...
        private void FillDDLDestMT()
        {
            try
            {
                ...
                ddlHelper.LoadDDLMT(db, ddlDestinationMT);
            }
            catch (Exception ex)
            {
        ...
        private void FillDDLSourceMT()
        {
            try
            {
                ...
                DDLFundSwitching ddlHelper = new DDLFundSwitching();
                ddlHelper.CerNmbr = int.Parse(txtCerNmbr.Text);
                ddlHelper.LoadDDLMT(db, ddlSourceMT);
            }
            catch (Exception ex)
            {
        ...
        private void CalculateAmmount()
        {
            try
            {
                ...
                fundSwitch.MoneyTypeNmbr = int.Parse(ddlSourceMT.SelectedValue);
                ...
                txtAmtToProcess.Text = fundSwitch.GetCalculationMT(db);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        private void UpdateCurrentDestinationFund()
        {
            try
            {
                ...
                fundSwitching.MoneyTypeNm = ddlDestinationMT.SelectedItem.Text.Replace(",", "");
        ...
        private void UpdateCurrentSourceFund()
        {
            try
            {
                ...
                fundSwitching.MoneyTypeNm = ddlSourceMT.SelectedItem.Text.Replace(",","");
                fundSwitching.Mode = 1;
