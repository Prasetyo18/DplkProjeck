<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FundSwitching_MoneyType.ascx.cs" Inherits="DPLKCORE.Form.PensionTransaction.UserControl.FundSwitching_MoneyType" %>
