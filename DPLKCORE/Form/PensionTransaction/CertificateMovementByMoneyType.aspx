<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="CertificateMovementByMoneyType.aspx.cs" Inherits="DPLKCORE.Form.PensionTransaction.CertificateMovementByMoneyType" %>
                    ...
                    <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <div class="col-6 mb-2">
                                    <div class="col mb-2" style="overflow-x: auto">
                                        <asp:GridView ID="DGR_FUND" Font-Size="XX-Small" class="gridview-table" AutoGenerateColumns="false" PageIndex="0" PageSize="5" AllowPaging="false" runat="server">
                                            <Columns>
                                                <asp:BoundField DataField="inv_type_nm" HeaderText="Source Fund">
                                                    <HeaderStyle Width="30%"></HeaderStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="money_type_nm" HeaderText="Source Money Type">
												<HeaderStyle Width="30%"></HeaderStyle>
											</asp:BoundField>
                                ...
                                <div class="col-6 mb-2">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="DDL_SRC_MT">Source Money Type</label>
                                        <div class="col-6 mb-2">
                                            <asp:dropdownlist id="DDL_SRC_MT" AutoPostBack="True" class="form-select" Runat="server"></asp:dropdownlist>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="DDL_DST_MT">Destination Money Type</label>
                                        <div class="col-6 mb-2">
                                            <asp:dropdownlist id="DDL_DST_MT" class="form-select" Runat="server"></asp:dropdownlist>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
