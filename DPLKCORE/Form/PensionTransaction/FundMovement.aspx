<%@ Page Title="" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FundMovement.aspx.cs" Inherits="DPLKCORE.Form.PensionTransaction.FundMovement" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<%@ Register TagName="SearchPanel" TagPrefix="uc" Src="~/Form/UserControl/SearchPanel.ascx" %>
<%@ Register TagName="FundSwitching" TagPrefix="uc" Src="~/Form/PensionTransaction/UserControl/FundSwitching.ascx" %>
<%@ Register TagName="CertificateList" TagPrefix="uc" Src="~/Form/PensionTransaction/UserControl/FundSwitching_CertificateList.ascx" %>
<%@ Register TagName="GroupList" TagPrefix="uc" Src="~/Form/PensionTransaction/UserControl/FundSwitching_GroupList.ascx" %>
    ...
    <div class="container-fluid px-4">
        <div class="card my-4">
            <div class="card-header">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaction / </span>Fund Movement</h4>
